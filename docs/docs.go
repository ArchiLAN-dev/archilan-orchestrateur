    ...
    "paths": {
        ...
        "/preflight-generations": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Player YAML and optional custom apworld hash",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.StartSlotPreflightRequest"
                        }
                    }
                ],
                "responses": {
                    "202": {
                        "description": "Accepted",
                        "schema": {
                            "$ref": "#/definitions/api.SlotPreflightResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/sessions/{sessionId}/generate": {
            "post": {
                ...
                "description": "Enqueues an async multiworld generation for the given session ID.\nDownloads apworlds and YAMLs from storage, runs generate_multiworld.py in a one-shot container.\nFires session.generated or session.crashed webhooks on completion.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/sessions/{sessionId}/launch-from-file": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "file",
                        "description": "The .archipelago or .zip game file",
                        "name": "file",
                        "in": "formData",
                        "required": true
                    },
    ...
    "definitions": {
        ...
        "api.ContainerResponse": {
            ...
            "properties": {
                ...
                "status": {
                    "description": "starting | running | stopped | crashed",
                    "type": "string"
                },
                "updatedAt": {
                    "type": "string"
